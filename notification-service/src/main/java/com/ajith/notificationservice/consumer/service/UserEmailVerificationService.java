...
public class UserEmailVerificationService {
    ...
    public void sendMail(UserEmailTokenEvent event) throws MessagingException, UnsupportedEncodingException {
        ...
        String content = "<html><body style='font-family: Arial, sans-serif;'>"
                ...
                + "<p>Hello,</p>"+"  "+event.getFullName ()
                + "<p>You have requested to verify your email.</p>"
                + "<p><a href='" + event.getToken ( ) + "' style='background-color: #007bff; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>Click here to verify your email</a></p>"
                + "<p>If the above link doesn't work, you can copy and paste this URL into your browser:</p>"
                + "<p><a href='" + event.getToken () + "'>" + event.getToken ( ) + "</a></p>"
